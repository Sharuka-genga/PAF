          ...
          <div className="p-6 border-b border-[rgba(255,255,255,0.08)]">
            ...
            <nav className="p-4 space-y-2">
              <div className="space-y-1">
                <a href="/admin" className="sidebar-item-premium group">
                  <FiHome className="w-5 h-5" />
                  <span className="text-white font-medium">Dashboard</span>
                </a>
                <a href="/admin/users" className="sidebar-item-premium group">
                  <FiUsers className="w-5 h-5" />
                  <span className="text-white font-medium">Users</span>
                </a>
                <a href="/admin/resources" className="sidebar-item-premium group">
                  <FiGrid className="w-5 h-5" />
                  <span className="text-white font-medium">Resources</span>
                </a>
                <a href="/admin/bookings" className="sidebar-item-premium group">
                  <FiCalendar className="w-5 h-5" />
                  <span className="text-white font-medium">Bookings</span>
                </a>
                <a href="/admin/tickets" className="sidebar-item-premium group">
