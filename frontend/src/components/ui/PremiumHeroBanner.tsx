...
const PremiumHeroBanner: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden mb-8 group">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm font-normal">
              Comprehensive system overview for {new Date().toLocaleDateString('en-US', { 
                weekday: 'long', 
                month: 'long', 
                day: 'numeric' 
              })}.
