        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full">
          ...
          <div>
            <h2 className="text-white text-5xl font-black tracking-tight leading-[1.1] mb-6">
              Empowering the <br />
              <span className="bg-gradient-to-r from-[#A78BFA] to-blue-400 bg-clip-text text-transparent">Digital Campus</span>
            </h2>
            <p className="text-gray-300 text-lg max-w-md font-medium leading-relaxed">
              Access all your university resources, bookings, and support tickets in one centralized, high-performance platform.
            </p>
          </div>

          <div className="flex items-center gap-4 text-gray-400 text-sm font-medium">
            <span className="flex items-center gap-1.5"><div className="w-1.5 h-1.5 bg-[#7C3AED] rounded-full shadow-[0_0_8px_#7C3AED]"></div> Intelligent</span>
            <span className="flex items-center gap-1.5"><div className="w-1.5 h-1.5 bg-[#7C3AED] rounded-full shadow-[0_0_8px_#7C3AED]"></div> Professional</span>
            <span className="flex items-center gap-1.5"><div className="w-1.5 h-1.5 bg-[#7C3AED] rounded-full shadow-[0_0_8px_#7C3AED]"></div> Secure</span>
          </div>
        </div>
      </div>

      {/* Right Side - Login Form */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 bg-[#FDFBF7]">
        <div className="max-w-md w-full mx-auto space-y-10">
          <div className="space-y-3">
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Sign in to account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between px-1">
                ...
                <a href="#" className="text-[10px] font-bold text-[#7C3AED] uppercase tracking-widest hover:underline">Forgot?</a>
              </div>
              <div className="relative group">
          ...
          <p className="text-center text-sm font-semibold text-gray-500">
            ...
            <Link to="/register" className="text-[#7C3AED] hover:text-[#6D28D9] font-bold transition-colors">
              Join for free
            </Link>
          </p>
        </div>
